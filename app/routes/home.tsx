...
const communityImages = [
  ...
  '/assets/community4jpg',
  '/assets/community5jpg',
  '/assets/community6jpg'
];

const eventsImages = [
  '/assets/IndabaEvent1.jpg',
  '/assets/IndabaEvent2.jpg',
  '/assets/IndabaEvent3.jpg',
  '/assets/IndabaEvent4.jpg'
];

const Home: React.FC = () => {
  return (
    <main className="bg-gray-50 dark:bg-gray-900 dark:text-white font-[Open_Sans]">
      {/* Hero Section */}
      <section
      ...
      {/* Culture Carousel */}
      <section className="py-16 px-4 bg-white/70 backdrop-blur-sm animate-bg-pulse">
      ...
      <div className="relative z-0">
        <div className="absolute inset-0 z-[-1] animate-bg-pattern" />
